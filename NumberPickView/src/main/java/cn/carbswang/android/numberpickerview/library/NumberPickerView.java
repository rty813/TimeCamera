...
public class NumberPickerView extends View{
    ...
    public void setDisplayedValues(String[] newDisplayedValues){
        ...
        if (mMaxValue== 0 && mMinValue==0){
            mMinValue = 1;
            mMaxValue = newDisplayedValues.length;
            mMinShowIndex = 0;
    ...
    public void refreshByNewDisplayedValues(String[] display) {
        ...
        int newMaxValue = minValue + display.length - 1;
    ...
    public void setMinValue(int minValue){
        ...
        if (mMinValue <= mMaxValue){
            ...
            String[] displayedValue = new String[list.size()];
            list.toArray(displayedValue);
            setDisplayedValues(displayedValue);
        }
        mMaxShowIndex = mMaxValue - mMinValue + mMinShowIndex;
    ...
    public void setMaxValue(int maxValue, boolean flag){
//        if(mDisplayedValues == null){
